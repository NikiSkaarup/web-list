...
<div class="container mx-auto space-y-8 p-8">
	...
	<section>
		<a class="btn variant-filled-primary" href="/">primary</a>
		<a class="btn variant-filled-secondary" href="/">secondary</a>
		<a class="btn variant-filled-tertiary" href="/">tertiary</a>
		<a class="btn variant-filled-success" href="/">success</a>
		<a class="btn variant-filled-warning" href="/">warning</a>
		<a class="btn variant-filled-error" href="/">error</a>
		<a class="btn variant-filled-surface" href="/">surface</a>
	</section>
	<section>
		<button class="btn variant-filled-primary" on:click={() => testData.set('primary')}>
			primary
		</button>
		<button class="btn variant-filled-secondary" on:click={() => testData.set('secondary')}>
			secondary
		</button>
		<button class="btn variant-filled-tertiary" on:click={() => testData.set('tertiary')}>
			tertiary
		</button>
		<button class="btn variant-filled-success" on:click={() => testData.set('success')}>
			success
		</button>
		<button class="btn variant-filled-warning" on:click={() => testData.set('warning')}>
			warning
		</button>
		<button class="btn variant-filled-error" on:click={() => testData.set('error')}>
			error
		</button>
		<button class="btn variant-filled-surface" on:click={() => testData.set('surface')}>
			surface
		</button>
	</section>
	<!-- <button
	...
	<CodeBlock language="json" code={$testData} />
	<CodeBlock language="json" code={JSON.stringify($page.data, null, 2)} />
</div>
<div class="container flex-1 mx-auto flex justify-center items-center">
