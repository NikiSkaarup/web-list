<script lang="ts">
	...
	import QBitTh from './qbit-th.svelte';
...
<div class="table-container">
	...
	{:else}
		<table class="table-hover table" bind:clientHeight={tableHeight}>
			<thead>
				<tr>
					<QBitTh title="title" sortBy="title" {sort} {setSort} />
					<QBitTh title="date" sortBy="dt" {sort} {setSort} />
					<QBitTh title="category" sortBy="cat" {sort} {setSort} />
					<QBitTh title="size" sortBy="size" {sort} {setSort} />
					<QBitTh title="ext_id" sortBy="ext_id" {sort} {setSort} />
					<QBitTh title="imdb" sortBy="imdb" {sort} {setSort} />
